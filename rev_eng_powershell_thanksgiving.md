...
```
;$soclose="f_i_v_e_c_t_f_{fivectf}-nope this would be to easy :)"
```
...
;set-variable -name turkylurky -value ("I hope you have a Happy and Joyful turkey day!...bm9uZXNlbnNle2lfY2FudF9lYXRfYW5vdGhlcl9ieXRlX29oX2xvb2tfcGllfQ==")
```
...
;set-variable -name beta -value ("I hope you have a Happy and Joyful turkey day!...bm9uZXNlbnNle2lfY2FudF9lYXRfYW5vdGhlcl9ieXRlX29oX2xvb2tfcGllfQ==")
```
...
;set-variable -name theta -value ("I hope you have a Happy and Joyful turkey day!...bm9uZXNlbnNle2lfY2FudF9lYXRfYW5vdGhlcl9ieXRlX29oX2xvb2tfcGllfQ==")
```
...
;set-variable -name delta -value ("5a6d6c325a573931636d52376232686662586c665a323931636d5239")
```
...
;set-variable -name eta -value ("9VGbiJ2b39Vdvl3XslGdfVGbiJ2bntXZsJmYvdXZ2lmZ")
```
...
;set-variable -name theta -value ("Ano2AD1eATE7AnEsx3IuyD9pAC0=")
```
...
;set-variable -name iota -value ("66697665726f6c6c737b746869735f69735f686f775f695f726f6c6c7d")
```
...
;set-variable -name zeta-value ("Zml2ZXRyYWlue29mZl90aGVfcmFpbHNfb25fZ3JheV90cmFpbn0=")
```
